- 2023년 초에 진행한 인터뷰에서 3년의 침체를 각오해야 한다고 한다.
  ...
  * [[2023/04/11]] ((6544931a-ab93-4f0d-b234-8d8789462d26)) 하고 함께 읽자.
	...
	- The text discusses the expectation of a difficult economic situation next year, with a lack of hope. It emphasizes that vulnerable groups, individuals with significant debt, and low-income households will face challenges. The repeated coverage of economic crises in various media outlets increases the sense of danger surrounding 2023. The stress caused by high interest rates is shaking the South Korean economy. Companies are making efforts to reduce interest costs, and concerns arise regarding the issuance of corporate bonds. Despite the government's attempts to reduce interest burdens, household debt continues to increase. Seoul National University Professor Lee Joon-gu warns that the economy may experience a downturn for the next three years. The professor also suggests that while certain regulations need to be relaxed, core measures to curb speculation in the real estate market should be maintained. The text concludes by highlighting the need for a shift in mindset from a scarcity mentality to
